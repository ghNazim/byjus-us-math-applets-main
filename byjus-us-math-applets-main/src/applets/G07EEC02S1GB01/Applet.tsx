...
import { DividedTemplate, fetchNextQuestion, QuestionsList } from './AppletElements/Elements'
...
const leftValues = [120, 440, 320, 440, 320, 520, 320]

export const AppletG07EEC02S1GB01: React.FC<{
    ...
    switch (selectedPan) {
      ...
      case 3:
        setButtonDisableStatus([
          true, //buttonStatusLeftPan[0] || buttonStatusRightPan[0],
          true, //buttonStatusLeftPan[1] || buttonStatusRightPan[1],
