...
import newTextSVG from './Assets/newText.svg'
...
`
const AnimatedFormulaBox = styled(FormulaBox)<{ animate: boolean }>`
  transition: transform 0.3s ease-out;
  transform: translateX(${(props) => (props.animate ? '150px' : '0')});
`
const NewTextSVG = styled(FormulaBox)`
  position: absolute;
  left: 200px;
  top: 560px;
`
  ...
  return (
    ...
    >
      ...
      <InputSlider
        ...
        reset={clickStage == 0}
      />
      <AnimatedFormulaBox animate={sliderVal === 1}>
        <ColumnBox1>
