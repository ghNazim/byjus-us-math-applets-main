...
const TITLES: TitleProps[] = [
  { title: 'Addition', titleColor: '#C882FA', children: [], bodyColor: '#FAF2FF' },
  { title: 'Subtraction', titleColor: '#81B3FF', children: [], bodyColor: '#F3F7FE' },
]

const DRAGGABLES: DraggableProps[] = [
  { title: 'Added to', parentId: 'Addition', bgColor: '#F4E5FF' },
  { title: 'Sum of', parentId: 'Addition', bgColor: '#F4E5FF' },
  { title: 'Plus', parentId: 'Addition', bgColor: '#F4E5FF' },
  { title: 'More than', parentId: 'Addition', bgColor: '#F4E5FF' },
  { title: 'Total of', parentId: 'Addition', bgColor: '#F4E5FF' },
  { title: 'Increased by', parentId: 'Addition', bgColor: '#F4E5FF' },
  { title: 'Subtracted from', parentId: 'Subtraction', bgColor: '#E8F0FE' },
  { title: 'Difference of', parentId: 'Subtraction', bgColor: '#E8F0FE' },
  { title: 'Less than', parentId: 'Subtraction', bgColor: '#E8F0FE' },
  { title: 'Take away', parentId: 'Subtraction', bgColor: '#E8F0FE' },
  { title: 'Decreased by', parentId: 'Subtraction', bgColor: '#E8F0FE' },
  { title: 'Fewer than', parentId: 'Subtraction', bgColor: '#E8F0FE' },
]
...
export const AppletG07NSC02S2GB01: FC<{
  ...
  return (
    <AppletContainer
      {...{
        aspectRatio: 0.9,
        borderColor: '#f6f6f6',
        id: 'g07-nsc02-s2-gb01',
        onEvent,
        className,
      }}
    >
      <TextHeader
        text="Explore the relation between the given phrases and
the mathematical operations."
      ...
      <OnboardingController>
        ...
        <BottomText>
          {currentDraggableIndex < DRAGGABLES.length ? (
            <>Move the phrase according to the mathematical operations they are associated with.</>
          ) : (
            <>
