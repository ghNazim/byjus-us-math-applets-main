...
export const Bg = styled.div<{ isAnswerCorrect: boolean | null }>`
  ...
  margin: 0 2%;
  background-color: ${(a) =>
    a.isAnswerCorrect === null ? '#f3f7fe' : a.isAnswerCorrect ? '#f3f7fe' : '#FFECF1'};
  height: 50%;
  top: 100px;
  z-index: -100;
  user-select: none;
...
export const Row = styled.div`
  ...
  text-align: left;
`
export const Cell = styled.span<{ isCommon: boolean; placed: boolean; avoidIsPlaced?: boolean }>`
  color: ${(a) => (a.placed || a.avoidIsPlaced ? (a.isCommon ? '#1CB9D9' : 'inherit') : 'inherit')};
