...
import animation from './assets/G06EEC3GB08_animation.json'
...
export const AppletG06EEC3GB08: FC<{
  ...
  useEffect(() => {
    if (currentNum !== 0) {
      ...
      setTargetProgress((currentNum - 1.01) * 0.25)
  ...
  return (
    ...
    >
      <TextHeader
        text="Evaluate the expressions to check for equivalence."
      ...
      {animComplete ? (
        <BottomText>
          {currentNum === 2
            ? 'Note that the output of both the equations is equal.'
            : 'The output of both the equations evaluate to be same. Hence, they are equivalent expressions.'}
        </BottomText>
      ) : undefined}
