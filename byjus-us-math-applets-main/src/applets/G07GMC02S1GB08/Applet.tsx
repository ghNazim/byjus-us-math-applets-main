...
import { click, moveHorizontally, rotateBothSides, slider } from '@/assets/onboarding'
...
import trynewbutton from './assets/trynew.svg'
...
export const AppletG07GMC02S1GB08: FC<{
  ...
  useEffect(() => {
    ...
    if (api != null && ggbLoaded) {
      ...
      if (option2) {
        ...
        api.registerObjectUpdateListener('o', () => {
          valueX = Boolean(api.getValue('o'))
          if (valueX === true) {
            setNextButtonActive(true)
          } else {
            setNextButtonActive(false)
  ...
  useEffect(() => {
    ...
    if (api != null && ggbLoaded) {
      if (option3PhaseII) {
        api.registerObjectUpdateListener('u_1', () => {
          valueZ1 = Boolean(api.getValue('u_1'))
          if (valueZ1 === true) {
  ...
  useEffect(() => {
    ...
    if (api != null && ggbLoaded) {
      if (option3PhaseII) {
        api.registerObjectUpdateListener('oo', () => {
          valueZ2 = Boolean(api.getValue('oo'))
          if (valueZ2 === true) {
            setNextButtonActive3(true)
          } else {
            setNextButtonActive3(false)
  ...
  useEffect(() => {
    ...
    if (api != null && ggbLoaded) {
      if (option2PhaseII) {
        api.registerObjectUpdateListener('w_1', () => {
          valueY3 = Boolean(api.getValue('w_1'))
          if (valueY3 === true) {
    ...
    return () => {
      ggb.current?.unregisterObjectUpdateListener('w_1')
    }
  }, [ggbLoaded, option2PhaseII]) // phase II Option 2
  ...
  useEffect(() => {
    ...
    if (api != null && ggbLoaded) {
      if (option2PhaseII) {
        api.registerObjectUpdateListener('u_3', () => {
          valueY4 = Boolean(api.getValue('u_3'))
          if (valueY4 === true) {
            setNextButtonActive1(true)
          } else {
            setNextButtonActive1(false)
    ...
    return () => {
      ggb.current?.unregisterObjectUpdateListener('u_3')
    }
  }, [ggbLoaded, option2PhaseII]) // phase II Option 2
  ...
  useEffect(() => {
    ...
    if (api != null && ggbLoaded) {
      if (option1PhaseII) {
        api.registerObjectUpdateListener('u_2', () => {
          valueX2 = Boolean(api.getValue('u_2'))
          if (valueX2 === true) {
    ...
    return () => {
      ggb.current?.unregisterObjectUpdateListener('u_2')
    }
  }, [ggbLoaded, option1PhaseII]) // phase II Option 1
  ...
  useEffect(() => {
    ...
    if (api != null && ggbLoaded) {
      if (option1PhaseII) {
        api.registerObjectUpdateListener('w_2', () => {
          valueX3 = Boolean(api.getValue('w_2'))
          if (valueX3 === true) {
            setNextButtonActive2(true)
          } else {
            setNextButtonActive2(false)
    ...
    return () => {
      ggb.current?.unregisterObjectUpdateListener('w_2')
    }
  }, [ggbLoaded, option1PhaseII]) // phase II Option 1
