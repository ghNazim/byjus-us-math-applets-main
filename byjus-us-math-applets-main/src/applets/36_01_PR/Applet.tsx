...
export const Applet3601Pr: React.FC<{
  ...
  useEffect(() => {
    if (resetTicker) setResetTicker(false)
  }, [resetTicker])
  ...
  return (
    ...
    >
      <TextHeader
        text="Mass of one unit cube is 1 ounce. What would be the mass of the bigger cube that is made of smaller unit cubes."
