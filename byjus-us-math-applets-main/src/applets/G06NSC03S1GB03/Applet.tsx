...
import patch from './asset/p1.jpg'
...
export const AppletG06NSC03S1GB03: FC<{
  ...
  return (
    <AppletContainer
      {...{
        aspectRatio: 0.9,
        borderColor: '#F6F6F6',
        id: 'g06-nsc03-s1-gb03',
        onEvent,
        className,
      }}
    >
      <TextHeader
        text="Explore long division method"
        backgroundColor="#F6F6F6"
        buttonColor="#1A1A1A"
        hideButton={true}
      />
      <GeogebraContainer materialId="ekjxvsb7" width={700} height={530} onApiReady={onGGBLoaded} />
      ...
      {ggbLoaded && <BottomTexts>{getHeaderText(prgValue)}</BottomTexts>}
      {prgValue !== 16 ? (
        <CheckButton hasValue={inputValue !== undefined} onClick={onCheckClick}>
          Check
        </CheckButton>
      ) : (
        <>
