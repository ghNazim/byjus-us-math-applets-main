...
`
const AnimatedSlicerButton = styled.button`
  width: auto;
  padding: 8px 26px;
  height: 60px;
  background: #1a1a1a;
  ...
  &:hover:not([disabled]) {
    ...
    img {
      scale: 1.2;
      animation: ${sliceAnimation} 0.5s ease-in-out;
      transition: 0.3s ease-out;
    }
    label {
      scale: 1.5;
...
export const AnimatedSliceButton: React.FC<ButtonProps> = (props) => (
  <AnimatedSlicerButton {...props}>
    <ButtonIcon src={props.imgSource} />
    <ButtonText>{props.children}</ButtonText>
  </AnimatedSlicerButton>
)
