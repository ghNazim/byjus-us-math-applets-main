...
export const textHolder = [
  <>
    To plot the line, find the the two points using {yInterceptText} and {slopeText}
  </>,
  <>Enter the {yInterceptText} value</>, //1
  ...
  <>Find the {yInterceptText} on the graph and move your pointer.</>, //5
  <>Oops! The pointer isn’t at the {yInterceptText}. Let&apos;s correct that</>,
...
}> = ({ yIntercept, slopeVals, colorBoxii }) => {
  return (
    <BoxHolder>
      <Box colorBlock={colorBoxii.interceptBox}>y-intercept = {yIntercept}</Box>
