...
export const AppletG07GMC03S1GB01: FC<{
  ...
  const texts = [
    ...
    '                         Measure and mark the angle 60°.',
    '                    Now, let’s proceed to the next step.',
    '                  Mark the vertex C at a length of 6 cm.',
    '                            Join vertex C with vertex B.',
    '         Great! You have constructed the given triangle.',
    '                  Mark the vertex C at a length of 9 cm.',
  ]
  ...
  const onClickHandle = (e: any) => {
    ...
    switch (e.target.id) {
      case '1':
        ...
        ggb.current?.evalCommand('RunClickScript(pic4)')
  ...
  return (
    ...
    >
      <TextHeader
        text="Construct a triangle with sides of length 9 cm and 6 cm with an included angle of 60°."
        backgroundColor="#F6F6F6"
        buttonColor="#1A1A1A"
      />
      <GeogebraContainer materialId="ys5sr4gt" top={70} left={0} onApiReady={onGGBLoaded} />
        ...
        <>
          <RadioDiv left={235} checked={option1} id={'1'} onClick={onClickHandle}>
            <RadioInnerDiv checked={option1}>
              ...
              <RadioLabel>
                <ColorText color={'#212121'}>6 cm</ColorText>
              </RadioLabel>
            </RadioInnerDiv>
          </RadioDiv>
          <RadioDiv left={385} checked={option2} id={'2'} onClick={onClickHandle}>
            <RadioInnerDiv checked={option2}>
              ...
              <RadioLabel>
                <ColorText color={'#212121'}>9 cm</ColorText>
              </RadioLabel>
            </RadioInnerDiv>
          </RadioDiv>
        </>
