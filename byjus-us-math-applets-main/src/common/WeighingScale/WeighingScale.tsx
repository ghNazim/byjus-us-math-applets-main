...
import { GeogebraAppApi } from '../Geogebra/Geogebra.types'
import EqualitySigns from './EqualitySigns'
import { IQuestion, ISliderValues, useQuestion } from './WeighingScale.context'
...
export const WeighingScale: React.FC<SliderValueProps> = ({
  ...
  return (
    <WeighingMachine>
      <Geogebra materialId="bew9xhy3" onApiReady={onGGBLoaded} />
      {ggbLoaded && (
        <>
          <SignDisplay>
            <EqualitySigns
